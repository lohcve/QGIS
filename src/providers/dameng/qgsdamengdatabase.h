...
#define        COLNAME_SIZE 256
#define        TABLENAME_SIZE 256
...
class QgsDMDriver : public QSqlDriver
{
  ...
  public:
    ...
    QString &getConnMsg() const { return mConnMsg; }
    void setConnMsg( const QString &msg ) { mConnMsg = msg; }
    bool isConnect();
...
class QgsDMResult : public QSqlResult
{
  ...
  private:
    ...
    QString             mResMsg = QStringLiteral( "" );
};
